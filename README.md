...
## 🖥️ 양동이
외관상 구별이 힘든 교통약자들이 대중교통을 이용할 때, 앱을 통해 좌석에 배치된 QR코드를 스캔하면 좌석에 배치된 LED가 점등됩니다. LED가 점등된 좌석을 이용하는 사람은 교통약자석 이용이 가능한 사람이라는 것을 대중교통 이용자들에게 시각적으로 보여주기 위한 Android App
...
## 📁 프로젝트 상세 설명
  앱 실행 후 제공되는 계정으로 로그인을 합니다. 로그인 후 카메라 촬영 화면이 나오면 탑승한 대중교통의 교통약자석에 배치된 QR코드를 스캔합니다. 스캔 후 나오는 좌석 배치도에서 탑승하길 희망하는 좌석을 선택 후 탑승합니다. 좌석의 LED가 점등되면 좌석에 앉고, 하차 시 하차버튼을 눌러 하차를 완료합니다.
...
- Zxing라이브러리를 통해, 기기 카메라를 사용해 QR코드 스캔 기능을 구현해볼 수 있었습니다.
