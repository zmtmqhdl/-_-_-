...
## 🖥️ QR Scan
외관상 구별이 힘든 교통약자들이 대중교통을 이용할 때, 교통약자석 이용이 가능한 사람이라는 것을 시각적으로 보여주는 앱
...
## 📁 파일 설명 및 사용법
  ...
  (1) 웹페이지 초기 화면  
  <img src="https://github.com/user-attachments/assets/81b6d5df-9acb-4782-bce0-7e35e93a9185" width="80%">
